...
\institute{\ \inst{1} Pleiad Lab, DCC, University of Chile, Santiago, Chile\\ \url{abergel@dcc.uchile.cl}\\
	\ \inst{2} Heinrich-Heine-Universit\"{a}t, D\"{u}ssel\-dorf, Germany\\\url{cfbolz@gmx.del}\\
	\ \inst{3} RMoD Research group, INRIA Lille-Nord Europe, France\\\url{stephane.ducasse@inria.fr}\\
	\ \inst{4} University of Bern, Switzerland\\\url{renggli@me.com}~~ \url{jorge.ressia@gmail.com}\\
}
