...
\title{DYLA'10: Fourth Workshop on Dynamic Languages and Applications}
%\subtitle{Subtitle Text, if any}

\author{Alexandre Bergel\inst{1}, Carl Friedrich Bolz\inst{2}, Simon Denier\inst{3}, Michael Haupt\inst{4}, Adrian Kuhn\inst{5}}

\titlerunning{4th Workshop on Dynamic Languages and Applications}
...
\institute{\ \inst{1} DCC, University of Chile, Santiago, Chile\\
	...
	\ \inst{4} Hasso-Plattner-Institut, Potsdam, Germany\\
	\ \inst{5} University of Bern, Switzerland
}
...
The main goal of this workshop is to bring together different dynamic language communities and favouring cross communities interaction. Dyla 2010 will be organised as a full day meeting, partly devoted to presentation of submitted position papers and partly devoted to tool demonstration.  All accepted papers will be made available for download from the workshop's web site.
...
%\begin{itemize}
%\item Johan Brichau            (Université catholique de Louvain, Belgium)
%\item Pascal Costanza         (Vrije Universiteit Brussel, Belgium)
%\item Erik Ernst                  (University of Aarhus, Denmark)
